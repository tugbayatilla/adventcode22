...
public class AdventDay5UnitTests
{
    ...
    {
        Assert.NotNull(_adventDay5.GetCurrentCargoState());
    }
    
    [Fact]
    public void cargo_state_contains_list_of_stack()
    {
        Assert.IsAssignableFrom<IEnumerable<object>>(_adventDay5.GetCurrentCargoState());
    }
    ...
    public void add_two_crate_to_first_stack_with_order_Z_and_N_then_pop_out_with_order_N_and_Z()
    {
        ...
        Assert.Equal("N",_adventDay5.GetCurrentCargoState()[0].Pop());
        Assert.Equal("Z",_adventDay5.GetCurrentCargoState()[0].Pop());
    }
    ...
    public void cargo_has_two_stacks_and_first_has_2_and_second_has_3_crates()
    {
        ...
        Assert.Equal(2,_adventDay5.GetCurrentCargoState()[0].Count);
        Assert.Equal(3,_adventDay5.GetCurrentCargoState()[1].Count);
