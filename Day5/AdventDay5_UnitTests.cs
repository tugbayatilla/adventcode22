...
public class AdventDay5UnitTests
{
    ...
    {
        Assert.NotNull(_adventDay5.GetCargo());
    }
    ...
    public void add_two_crate_to_first_stack_with_order_Z_and_N_then_pop_out_with_order_N_and_Z()
    {
        ...
        Assert.Equal("N",_adventDay5.GetCargo().GetStack(0).Pop());
        Assert.Equal("Z",_adventDay5.GetCargo().GetStack(0).Pop());
    }
    
    [Fact(Skip = "one step back")]
